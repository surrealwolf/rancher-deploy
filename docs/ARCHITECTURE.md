...
│  │ 192.168.14.101         │  │ 192.168.14.111           │   │
│  │ 4 cores, 8GB RAM       │  │ 4 cores, 8GB RAM         │   │
│  ├────────────────────────┤  ├──────────────────────────┤   │
│  │ VM 403: Manager-3      │  │ VM 406: Apps-3           │   │
│  │ 192.168.14.102         │  │ 192.168.14.112           │   │
│  │ 4 cores, 8GB RAM       │  │ 4 cores, 8GB RAM         │   │
│  └────────────────────────┘  └──────────────────────────┘   │
│           │                            │                    │
│           └───────────────┬────────────┘                    │
...
|---------|-------|----------|-----------|
| Rancher Manager | 3 | 192.168.14.100-102 | rancher-manager-{1,2,3} |
| NPRD Apps | 3 | 192.168.14.110-112 | nprd-apps-{1,2,3} |
