...
variable "register_downstream_cluster" {
  description = "Whether to automatically register downstream cluster (nprd-apps) with Rancher Manager"
  type        = bool
  default     = true
}

variable "rancher_registration_token" {
  description = "DEPRECATED: Token for registering downstream cluster - now auto-generated by rancher2 provider"
  type        = string
  sensitive   = true
  default     = ""
}
...
variable "rancher_ca_checksum" {
  description = "DEPRECATED: CA checksum - now auto-generated by rancher2 provider"
  type        = string
  default     = ""
}
